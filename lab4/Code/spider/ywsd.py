...
def crawl_nankai_news():
    base_url = 'https://news.nankai.edu.cn/ywsd/system/count//0003000/000000000000/000/000/c0003000000000000000_000000640.shtml'
    all_news = []
    ...
    # 将抓取的数据保存为 JSON 文件
    with open('nankai_news_ywsd.json', 'w', encoding='utf-8') as f:
