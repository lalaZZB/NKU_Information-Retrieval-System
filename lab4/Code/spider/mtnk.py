...
def crawl_nankai_news():
    base_url = 'https://news.nankai.edu.cn/mtnk/system/count//0006000/000000000000/000/000/c0006000000000000000_000000500.shtml'
    all_news = []
    ...
    # 将抓取的数据保存为 JSON 文件
    with open('nankai_news_mtnk301.json', 'w', encoding='utf-8') as f:
