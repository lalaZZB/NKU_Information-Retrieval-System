...
def crawl_nankai_news():
    base_url = 'https://news.nankai.edu.cn/nkdxb/system/count//0011000/000000000000/000/000/c0011000000000000000_000000077.shtml'
    all_news = []
    ...
    # 将抓取的数据保存为 JSON 文件
    with open('nankai_news_nkdxb.json', 'w', encoding='utf-8') as f:
